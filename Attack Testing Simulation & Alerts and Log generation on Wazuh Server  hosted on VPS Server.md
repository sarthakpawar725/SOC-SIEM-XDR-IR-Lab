...
## Attack 2: —Successful SSH login from attacker Mac to Kali
...
## Attack 3 — Privilege escalation (sudo usage)
...
This event is associated with **Rule ID 554**, which corresponds to “File added to the system.” The alert details include:
